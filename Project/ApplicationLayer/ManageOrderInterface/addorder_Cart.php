...
?>
        ...
        <div class="row">
            ...
            <div class="column" style="background-color:#c69f9f;">
                ...
                <br>
                <h4><b>Price : RM <?= $row['menu_price']?> </b></h4>
                ...
                <br>
                <p>Quantity : <br> <br><input type="number" id="order_quantity" name="order_quantity"
                        class="form-control" value="1" min="1" max="5"></p>
                ...
                <center><button class="btn btn-primary" type="submit" name="add" value="Add to Cart"> Add to Cart
                    </button></center>
