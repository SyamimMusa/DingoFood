<?php 
include '../../BusinessServiceLayer/controller/menuController.php';
...
?>
    ...
    <div class="container" style="margin-top:20px">
        <center>
            <h2><?php echo isset($_GET['menu_category'])? $_GET['menu_category']: '';?> Menu</h2>
            <div class="row">
                <center>
                ...
                foreach($data as $row){
                    ...
                    echo "<div class='col-sm-4'>
                    		<div class='card'>
                    		<a href='../../ApplicationLayer/ManageOrderInterface/addOrder_Cart.php?menu_id=$menu_id'>
                    		<img class='picture' src='../../img/". $row['menu_image'] ."'></a>
                    			<h3>".$row['menu_name'] ."</h3>
                    		
                    			<p class='price'>RM". $row['menu_price'] ."</p>
                    			<p>". $row['menu_description'] ."</p>
      							<p class='status'> ". $row['menu_status'] ."</p>
      							<p><a href='../../ApplicationLayer/ManageOrderInterface/addOrder_Cart.php?id=" . $row['menu_id'] . "'><button>Add to Cart</button></a></p>
                    		</div>
                    		<br><br>
                    	</div>";
   				}
